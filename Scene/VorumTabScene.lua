...
function scene:createScene( event )
	...
	scrollView = scrollViewForPost.newScrollView{
													...
													topPadding = header.headerHeight + 55,
													refreshHeader = {
													height = 0,
													textToPull=localization.getLocalization("textToPull"),
													textToRelease=localization.getLocalization("textToRelease"),
													loadingText=localization.getLocalization("loadingText"),
													},
													bottomPadding = 40,
